...
var SchemaSymbol = exports.SchemaSymbol = Symbol();
...
function getComponentSchema(component) {
  if (typeof component.propTypes === 'undefined') throw new Error('Component ' + component.displayName + ' has no propTypes.');

  if (typeof component.propTypes[SchemaSymbol] === 'undefined') throw new Error('Component ' + component.displayName + ' has no JSON Schema propType definition.');
